...
from models.taming.data.annotated_objects_dataset import AnnotatedObjectsDataset
from models.taming.data.helper_types import Annotation, ImageDescription, Category
