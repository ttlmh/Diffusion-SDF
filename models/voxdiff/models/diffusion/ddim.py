...
from models.voxdiff.modules.diffusionmodules.util import make_ddim_sampling_parameters, make_ddim_timesteps, noise_like
...
class DDIMSampler(object):
    ...
    def sample(self,
        ...
        self.make_schedule(ddim_num_steps=S, ddim_discretize='slow_fast', ddim_eta=eta, verbose=verbose)
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if self.model.parameterization == "x0":
            real_e_t = (x - e_t * a_t.sqrt()) / sqrt_one_minus_at
            pred_x0 = e_t
            dir_xt = (1. - a_prev - sigma_t ** 2).sqrt() * real_e_t
